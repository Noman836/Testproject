...
User.create(email: 'customer@gmail.com', password: '123123', password_confirmation: '123123', user_type: 'customer')
User.create(email: 'admin@gmail.com', password: '123123', password_confirmation: '123123', user_type: 'admin')